...
function [T_x_simu,T_y_simu,q_simu]=simulation(param,fspace_x,fspace_y,coef,mu_simu,post_simu)
...
Q_simu    = (1+q_simu.^(param.theta/(param.theta-1))).^((param.theta-1)/param.theta);
