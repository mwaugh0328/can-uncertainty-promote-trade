...
---------------------------------------------------------------------------
         ...
         for various levels of signal precision (behind Figure 7)
         
           Simulates to compute trade and utility correlation
---------------------------------------------------------------------------
---------------------------------------------------------------------------
...
for j=1:N_eta   %Solves model and simulates for each level of signal precision
    ...
    %Generate signals using corresponding precisions
    ...
    %Run simulation, saves trade and utility correlation
    [corr_T(:,j),corr_C(:,j)] =  simulation(param,fspace_x,fspace_y,coef,mu_simu,post_simu);
end

save results_risksharing